...
class Platform extends Group {
    constructor() {
        ...
        this.platformMaterial = new MeshStandardMaterial({color: 0xFFCA3A, side: BackSide});//DoubleSide});
        ...
        //group.add(platform);
        let platform = new Mesh(platformCenterGeometry, this.platformMaterial)
        platform.scale.multiplyScalar(1.15);
        group.add(platform);
        ...
        //group.add(outline);
        let outline = new Mesh(platformCenterGeometry, this.outlineMaterial);
